...
extension FileHandle {
    ...
    func writeApplicaitonInfo() {
        ...
        header += "Armagnac Version: \(Bundle.main.infoDictionary?["CFBundleShortVersionString"] ?? "")\n"
    ...
    func writeInfo(for bottle: Bottle) {
        ...
        if let version = ArmagnacWineInstaller.armagnacWineVersion() {
            header += "ArmagnacWine Version: \(version.major).\(version.minor).\(version.patch)\n"
        }
