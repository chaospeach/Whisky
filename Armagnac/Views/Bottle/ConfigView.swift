...
struct ConfigView: View {
    ...
    var body: some View {
        ...
        .formStyle(.grouped)
        .animation(.armagnacDefault, value: wineSectionExpanded)
        .animation(.armagnacDefault, value: dxvkSectionExpanded)
        .animation(.armagnacDefault, value: metalSectionExpanded)
        .bottomBar {
            HStack {
                Spacer()
